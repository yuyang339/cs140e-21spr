...
/* 
 * We inline the computation for <cycle_per_bit> b/c we don't have 
 * division on the pi.  division by a constant allows the compiler 
 * to pre-compute.  can make your own "constructor" if you need
 * to do things differently.
 */
#define sw_uart_mk(_tx,_rx,_baud) \
    sw_uart_mk_helper(_tx,_rx, _baud, (700*1000*1000UL)/_baud)
